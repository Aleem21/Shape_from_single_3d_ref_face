function [ lin_srgb ] = imread_raw( impath )
...
sRGB_to_cam = sRGB_to_cam./ repmat(sum(sRGB_to_cam,2),1,3);
cam_to_sRGB = inv(sRGB_to_cam);
lin_srgb = correct(lin_rgb,cam_to_sRGB);
end
