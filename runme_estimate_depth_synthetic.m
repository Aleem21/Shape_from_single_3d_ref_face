...
% center = 1;
% center = 0;
% Rpose = makehgtform('scale',[1 1 1])* makehgtform('zrotate',deg2rad(-10))*makehgtform('xrotate',deg2rad(20))*makehgtform('yrotate',deg2rad(10));
...
noise = randn(size(dmap_ref));
depth = estimate_depth(N_ref,alb_ref,im,dmap_ref+noise,l_est,.1);
